...
bool CSerial::SetDTR (void)
{
	return EscapeCommFunction( m_hFile, SETDTR );
}

bool CSerial::ClrDTR (void)
{
	return EscapeCommFunction( m_hFile, CLRDTR );
}

bool CSerial::SetRTS (void)
{
	return EscapeCommFunction( m_hFile, SETRTS );
}

bool CSerial::ClrRTS (void)
{
	return EscapeCommFunction( m_hFile, CLRRTS );
}
