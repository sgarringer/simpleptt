...
#define WINVER 0x0501		// Change this to the appropriate value to target Windows XP and later
#endif
...
#define _WIN32_WINDOWS 0x0501 // Change this to the appropriate value to target Windows XP.
#endif
...
#define WU_EVENT_SERIALPORT WM_USER+1
